...
function MiniResultRow({ r }) {
  ...
  return (
    <tr>
      ...
      <td style={{ color: '#777', fontSize: 12 }}>{r.date}</td>
    </tr>
  )
}
    ...
    <div className="jk-dashboard">
      <div className="jockey-page-head">
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <Link to="/jockey/profile" className="jockey-btn jockey-btn--gold">
            ◎ Hồ sơ
          </Link>
        </div>
      </div>
      ...
      {upcoming && (
        <div className="jk-upcoming-banner">
          ...
          <Link to="/jockey/my-races" className="jockey-btn jockey-btn--gold jockey-btn--sm">
            Chi tiết →
          </Link>
        </div>
      )}
